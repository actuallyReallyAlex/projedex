    ...
    <div>
      ...
      <Segment raised color="green">
        ...
        <Form loading={loading} onSubmit={handleSubmit}>
          <Form.Field control={Input} label="Name" onChange={e => setName(e.target.value)} required value={name} width="4" />
          <Form.Field control={Input} label="Description" onChange={e => setDescription(e.target.value)} value={description} width="10" />
          <div
            style={{
          ...
          >
            <Button disabled={!name} primary style={{ marginBottom: '14px', marginTop: '14px' }} type="submit">
              Create project
            </Button>
          </div>
        </Form>
