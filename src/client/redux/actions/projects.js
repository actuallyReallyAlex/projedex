...
export const deleteProject = id => async (dispatch, getState) => {
  try {
    ...
    dispatch(setProjectData(projects.projectData.filter(project => project._id !== id)))
 ...
 */
export const modifyProject = (id, modification) => async (dispatch, getState) => {
  try {
    ...
    const modifiedProjectIndex = newProjectsArray.findIndex(project => project._id === id)
